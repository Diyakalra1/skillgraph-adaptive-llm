...
"""
FastAPI application for the Skillgraph Adaptive Env Environment.

This module creates an HTTP server that exposes the SkillgraphAdaptiveEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m skillgraph_adaptive_env.server.app
    ...
    multiple workers:
        uvicorn skillgraph_adaptive_env.server.app:app --workers 4
    """
    import uvicorn
